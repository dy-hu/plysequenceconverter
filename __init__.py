...
from .ply_sequence_converter import *
from .panels import *

bl_info = {
    "name": "Point Cloud Sequence Importer",
    "description": "Import a sequence of .PLY files and display them each as a single frame of animation. Supports Blender 4.0",
    "author": "Daniel Hu, Justin Jensen",
    "version": (1, 0, 0),
    "blender": (4, 0, 0),
    "location": "File > Import > Mesh Sequence",
    "warning": "",
    "category": "Import",
    "wiki_url": "https://github.com/dy-hu/plysequenceconverter",
    "tracker_url": "https://github.com/dy-hu/plysequenceconverter"
}
